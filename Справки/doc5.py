        ...
        if file_path:
            try:
                ...
                for data in extracted_data:
                    self.result_textbox.append(f"ИНН медицинского учреждения: {data['ИНН медицинского учреждения']}")
                    self.result_textbox.append(f"Адрес медицинского учреждения: {data['Адрес медицинского учреждения']}")
                    self.result_textbox.append(f"ФИО пациента: {data['ФИО пациента']}")
                    self.result_textbox.append(f"ИНН пациента: {data['ИНН пациента']}")
                    self.result_textbox.append(f"Стоимость услуги: {data['Стоимость услуги']}")
